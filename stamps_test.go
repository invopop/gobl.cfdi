...
func TestStamp(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			value: "https://verificacfdi.facturaelectronica.sat.gob.mx/default.aspx?id=fd53505e-d737-43ab-815c-8090edec3655&tt=201.36&re=EKU9003173C9&rr=EKU9003173C9&fe=bUthyQ==",
		},
		{
			name:  "Provider RFC",
